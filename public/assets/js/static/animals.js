var animalNames = {
	...
	"worm":{
		...
		'link': 'https://jkijiner.wordpress.com/2011/04/13/tell-them/',
		"zones": [2, 3, 4],
		"number": 8,
		"symbol": '⩷',
		...
		"personality": "funny",
		"type": "parasite",
		'quote': '"we don\'t want to leave"',
		'narrative': ['we are skies uncluttered</br>majestic in their sweeping landscape', 'and after all this</br>tell them about the water</br>how we have seen it rising</br>flooding across our cemeteries</br>gushing over the sea walls </br> and crashing against our homes', 'but most importantly tell them</br>we don’t want to leave</br>we’ve never wanted to leave</br>and that we</br>are nothing without our islands.']
	},

	"nematode":{
		"name": "nunataq",
		'author': 'joan naviyuk kane',
		'link': 'https://poets.org/poem/nunataq',
		"zones": [2, 3, 4],
		"number": 8,
		"symbol": '⫻',
		"shades": ["#9cabc9"],
		...
		"type": "parasite",
		'quote': '"one does wish"',
		'narrative': ['a glacier I might pronounce like grief.', 'One does wish for words to thaw </br>in the mouth, but find instead a tongue,</br>welt. Erosional or depositional, raised </br> & visible, rift into language & grit—', 'In a strait, some things are useful.</br>Others, true, she turns to ash. ']
	},

	"human":{
		"name": "romance #1",
		'author': 'eunsong kim',
		'link': 'https://poets.org/poem/romance-1-0',
		"zones": [4, 5],
		"number": 8,
		"symbol": '人',
		...
		"type": "predator",
		'quote': '"what will end:"',
		'narrative': ['like some 14 year old girl waiting for her crush to glance back i </br></br>keep waiting for capitalism to end', 'News. News:</br></br>Might a few jellyfish survive—</br></br>counting till revelations becomes part of—']
	},

	"dog":{
		"name": "comprador",
		'author': 'mark steven',
		'link': 'https://proteanmag.com/2019/12/09/comprador/',
		"zones": [1, 2, 3, 5],
		"number": 8,
		"symbol": '⌘',
		"shades": ['#ff9933', '#994d00', ' #ffdf80', '#8c8c8c', '#d9d9d9'],
		"personality": "chatty",
		"type": "predator",
		'quote': '"in petroleum superbloom"',
		'narrative': ['code red baia mare</br>chernobyl minamata</br>deepwater fukushima', 'just a fire in the distance</br>when together we discover</br>in petroleum superbloom', 'The thing about realism</br>is industry really means</br>extraction but extraction</br></br>now means extinction</br>so industry is code</br>for annihilation as in']
	},

	"frog":{
		"name": "post-factual love poem",
		'author': 'paul guest',
